...
import { CalendarDays, FolderKanban, Flame, NotebookPen, ChevronLeft, ChevronRight, LogOut, Settings, ShieldCheck } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/vault', label: '금고', sub: '암호화 저장소', icon: ShieldCheck },
]
